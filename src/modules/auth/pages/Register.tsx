...
import { GenderEnum, IBaseUser } from '../interfacesAndTypes/userInfo'

const genders = [
  { label: 'auth.register.form.gender.options.f', value: GenderEnum.Female },
  { label: 'auth.register.form.gender.options.m', value: GenderEnum.Male },
]
...
const Register = (): JSX.Element => {
  ...
  const handleRegister = async (values: Partial<IBaseUser>) => {
    register(values)
      .then(() => {
